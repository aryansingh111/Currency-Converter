...
>
  <div className="w-full max-w-6xl flex flex-col lg:flex-row bg-white/30 backdrop-blur-sm rounded-lg p-5 shadow-2xl">
    ...
    <div className="hidden lg:flex w-1/3 items-center justify-center p-5">
      <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-600 drop-shadow-lg shadow-indigo-600/50 ml-5">
        Currency Calculator
      </h1>
    </div>
